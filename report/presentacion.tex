...
\begin{frame}{Interacción Tipo Votante}
    ...
    Simulaciones:
    \begin{itemize}
        \item 6 simulaciones con $T=2000$ para $N=300$ y $L=10$ variando $\eta$ en $[0;0.05]$ con pasos de $0.01$.
        \item 11 simulaciones con $T=2000$ para $L=10$ y $\eta=0$ variando $N$ en $[300;2000]$.
    \end{itemize}
\end{frame}
