...
simulation_name = input("Ingrese el nombre de la simulacion (sin espacios): ")
params = vicsek.VicsekParams(seed=np.random.randint(0, datetime.now().timestamp()))
...
voter = input('Ingrese si la interaccion es de tipo votante o no (SI o NO) (default NO): ')
...
vicsek.save_simulation(simulation_name, params, states_xy, states_theta)
print("Simulación 'Off - Lattice' generada con éxito")
